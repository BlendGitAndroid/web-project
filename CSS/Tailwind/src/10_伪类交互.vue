<template>
  <div>
    <h2>伪类交互</h2>
    <button class="border rounded-full px-2 py-1 text-white bg-cyan-400 hover:bg-cyan-600 active:bg-cyan-950">
      这是一个按钮
    </button>
    <input type="text" disabled class="disabled:bg-red-500"/>

    <input type="text" class="border focus:bg-red-500 placeholder:font-bold placeholder:text-blue-500"
           placeholder="请输入用户名"/>
    ...
    <div class="group/edit">
      ...
      <div class="group/save">
        ...
        <button
            class="border rounded-full px-2 py-1 text-white bg-cyan-400 group-hover/save:bg-blue-600 group-active/save:bg-blue-950">
          保存
        </button>
        <button
            class="border rounded-full px-2 py-1 text-white  bg-cyan-400 group-hover/edit:bg-cyan-600 group-active/edit:bg-cyan-950">
          编辑
        </button>
      </div>
    </div>
